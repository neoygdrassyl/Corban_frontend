...
export default function FUN_CHART_ENG_R(props) {
    ...
    var [hovered, setHovered] = useState(false);
        ...
        let myData = () => {
            ...
            return [
                { y: 0.5, x: val_3_p, group: 'est:si', val: val_3, val_p: val_3_p, color: 'Red', title: `CUMPLE: ${val_3} (${val_3_p.toFixed(2)}%)`, strokeWidth: 10, hintText: 'CUMPLE: ' + val_3 },
                { y: 0.5, x: val_2_p, group: 'est:no', val: val_2, val_p: val_2_p, color: 'DarkRed', title: `NO CUMPLE: ${val_2} (${val_2_p.toFixed(2)}%)`, strokeWidth: 10, hintText: 'NO CUMPLE: ' + val_2 },
                { y: 0.5, x: val_1_p, group: 'est:0', val: val_1, val_p: val_1_p, color: 'Gainsboro', title: `SIN EVALUAR: ${val_1} (${val_1_p.toFixed(2)}%)`, strokeWidth: 10, hintText: 'SIN EVALUAR: ' + val_1 },
            ]
        }
        ...
        return (
            <Row className="border p-2">
                <Row className="text-center my-2">
                    <label className="fw-b">INFORMES ESTRUCTURALES ({items.length})</label>
                </Row>
                <Row>
